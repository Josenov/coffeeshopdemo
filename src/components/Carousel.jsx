...
const Carousel = () => {
    ...
    return (
        <div className="flex items-center justify-center p-1 lg:w-[800px] lg:h-[400px] mb-3">
            ...
            <img className='absolute  md:w-[900px] object-cover flex justify-center h-64 md:h-full md:rounded-md ' src={images[index].url} alt="" />
                <button onClick={handlePrevBtn} type="button" className="flex absolute left-0  justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev>
