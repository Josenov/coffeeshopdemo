    ...
    return (
        ...
        <>
            ...
            <div id='main' className="flex items-center justify-center text-center  text-white font-semibold  md:font-semibold">
                <div className=" text-center absolute z-[50] justify-center mt-[200px]">
                    <p className="lg:mt-[350px] text-3xl md:w-96">"Sip, Savor, Smile: Where Every Cup Tells a Story!"</p>
                    ...
                    <div className="md:w-[400px] mt-2 p-2">
                    <ReadMoreBtn
